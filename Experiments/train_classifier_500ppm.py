...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--abmil_lr", type=float, default=5e-4, help="ABMIL learning rate (default: 2e-4)")
    p.add_argument("--abmil_wd", type=float, default=1e-5, help="ABMIL weight decay (default: 1e-4)")
    p.add_argument("--abmil_epochs", type=int, default=20, help="ABMIL training epochs (default: 500)")
    p.add_argument("--abmil_patience", type=int, default=5, help="ABMIL early stopping patience (default: 50)")
    p.add_argument("--abmil_instance_dropout", type=float, default=0.2, help="Randomly drop this fraction of instances per bag during training (default: 0.1)")
